  ...
  return (
    <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 my-[8ch]'>
        <div className="w-full items-center flex justify-between">
            ...
            <Link to={"/bus"} className='text-violet-600'>Xem tất cả</Link>
        </div>
        <div className="grid grid-cols-3 gap-6">
            <Link to={'/bus'} className='bg-neutral-200/60 dark:bg-neutral-900/40 block rounded-xl px-4 relative group ease-in-out duration-300 overflow-hidden'>
